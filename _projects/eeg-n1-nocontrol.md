...
collaborators:
   ...
   - "Matto Leeuwis"
   - "Patrick Forbes"
image: /assets/projects/eeg-n1-nocontrol-thumb.jpg   # path to the thumbnail
image_alt: N1 response in control and without                # optional
\# code: https://github.com/USER/REPO            # (add if/when public)
link: https://doi.org/10.1113/JP290280
---
...
Our study was selected as Editor's choice, discussed in a Perspective, and featured as the Issue cover with Daphne's beautiful artwork: [issue cover](https://physoc.onlinelibrary.wiley.com/doi/10.1113/tjp.70601)

![Visual abstract](/assets/projects/eeg-n1-nocontrol-visual-abstract.jpg)