---
layout: project
title: "Asymmetry and energy expenditure during standing"
date: 2026-09-17
summary: Does our tendency to stand in highly asymmetric postures result from minimizing energy expenditure?
tags: [posture, biomechanics, energetics]
status: "Published"
collaborators:
   - "Matto Leeuwis"
   - "Ralf Rienks"
   ...
   - "Johan Pel"
   - "Patrick Forbes"
image: /assets/projects/asymmetry-thumb.jpg   # path to the thumbnail
image_alt: Michelangelo's David wearing a metabolic mask
\# code: https://github.com/USER/REPO            # (add if/when public)
link: https://doi.org/10.1152/japplphysiol.00294.2026
---
...
Paper: [Journal of Applied Physiology](https://doi.org/10.1152/japplphysiol.00294.2026)

Data: [DataVerseNL](https://doi.org/10.34894/IB09YA)
